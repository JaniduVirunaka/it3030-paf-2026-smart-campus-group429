                    ...
                    <div className="hidden md:flex items-center gap-1">
                        {user ? (
                            <>
                                ...
                                <Link to="/profile" className="px-4 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-colors">
                                    Profile
                                </Link>
                            </>
                        ) : null}
